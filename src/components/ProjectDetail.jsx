							...
							<h3 className="text-lg md:text-xl font-semibold text-white/90 flex items-center gap-2 md:gap-3">
								...
								{project.CompletedDate ? (
									<div className="flex items-center gap-2">
										<h3 className="bg-gradient-to-r from-blue-200 via-purple-200 to-pink-200 bg-clip-text text-transparent leading-tight">
											Completed On:
										</h3>
										<p className="text-gray-300/90 font-normal">
											{project.CompletedDate}
										</p>
									</div>
								) : (
									<p className="text-base md:text-lg text-gray-300/90 italic">
										Ongoing Project
									</p>
								)}
							</h3>
